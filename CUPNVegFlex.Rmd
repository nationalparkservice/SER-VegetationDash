...
checkboxGroupInput("sel_OakHickRpts", 
                   ...
                   choiceNames = list("Sander threshold"),
                   choiceValues = list("OakHickSander"),
...
observeEvent(eventExpr = input$button_load, {
  ...
  saveRDS(isolate(reactiveValuesToList(Out_list)), "Temp.RDS")
  Sys.sleep(0.25)
...
observeEvent(eventExpr = input$button_rpts, {
  withProgress(message = "Generating reports...", value = 0, {
    ...
    #     rmarkdown::render(here::here("RMD_files", "OakHick_OSI_Import.Rmd"), output_format = input$sel_rptformat, output_file = paste0(here::here("Reports_out"), "/OakHickOSI", switch(input$sel_rptformat, word_document = ".doc", pdf_document = ".pdf")), params = list(type = "MeanOSI"))}
